...
electricity for current drive, 40% wall-to-injected) so the condition
...
P_wall_allow = 100.0   # MW electric, budget for current drive in the 1 GW_e plant
eta_wi       = 0.40    # wall-to-injected efficiency (Menard's assumption too)
