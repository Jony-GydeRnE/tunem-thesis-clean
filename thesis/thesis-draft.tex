...
pilot-plant analysis likewise assumes a neutral-beam wall-plug efficiency of
$0.4$.\footnote{Freidberg \emph{et al.}, Sec.~4.6; Menard \emph{et al.}, Sec.~2.1.6, where
$\eta_{\rm aux}=0.4$ is described as higher than presently achievable, and Sec.~5.3. The arithmetic is reproduced in
...
finite-$A$ calculation on pages 106--111 answered Freidberg's two current questions.
...
($I_{\rm CD,allow}\ge2.6$--$2.9\,\mathrm{MA}$, page 111), whereas merely raising
$H$ in that baseline did neither. It does not establish a theorem
