...
\]
This linear potential has a deeper formulation in gauge theory called the \emph{area law}. A quark and antiquark followed through time trace the boundary of a surface in spacetime; for a confining theory, the relevant Wilson loop is controlled by the area of that surface. For a rectangular loop of spatial width \(r\) and time length \(T\), that area is \(rT\), and the area law leads directly to a potential proportional to \(r\). Thus the geometric statement ``more separation means proportionally more stored field energy'' is the intuitive face of the area law.\refn{5}
